...
\S\ref{sec:future}. \S\ref{sec:avail} describes the terms under which Comet is
available and how to obtain it, while a summary of the results are presented
and some more general conclusions drawn for future of VOEvent transport in
...
and the number of subscribers which a broker can conveniently service.
...
more than a timestamp reflecting when the event was created: see
Listing~\ref{lst:testmessage} for an example.
