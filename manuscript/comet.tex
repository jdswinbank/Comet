...
summarized in \S\ref{sec:future}, while a summary of the results are
...
higher round-trip times were always suppressed relative to the througput
...
\S\S\ref{sec:perf:throughput} and \ref{sec:perf:highlatency} demonstrated that
