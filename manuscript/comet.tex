...
instruments such as LSST\footnote{Note that LSST itself will not transmit
alerts directly from the observatory; for that specific event stream, a round
trip time of 500\,ms is likely unreasonably pessimistic.}. This is a
significant flaw in the VTP system. It is to be hoped that future revisions
can address the issue; for further discussion, see \S\ref{sec:future:bulk}.
...
An alternative approach is to group batches of events into a single data
