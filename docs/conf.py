...
from comet import __name__ as project
...
latex_documents = [
  ('index', 'Comet.tex', u'Comet Documentation',
   u'John Swinbank', 'manual'),
]
...
man_pages = [
    ('index', 'comet', u'Comet Documentation',
     [u'John Swinbank'], 1)
]
...
texinfo_documents = [
  ('index', 'Comet', u'Comet Documentation',
   u'John Swinbank', 'Comet', 'One line description of project.',
   'Miscellaneous'),
]
