...
class coerce_to_client_endpoint_TestCase(unittest.TestCase):
    ...
    def test_good_tcp_parse(self):
        ep = coerce_to_client_endpoint(reactor,
    ...
    def test_good_unix_parse(self):
        filename = "/dev/null"
        ep = coerce_to_client_endpoint(reactor, f"unix:{filename}",
                                       self.DEFAULT_PORT)
    ...
    def test_bad_parse(self):
        self.assertRaises(ValueError, coerce_to_client_endpoint, reactor,
                          "tcp:tcp:tcp", self.DEFAULT_PORT)
...
class coerce_to_server_endpoint_TestCase(unittest.TestCase):
    ...
    def test_bad_parse(self):
        self.assertRaises(ValueError, coerce_to_server_endpoint,
                          reactor, "tcp:")
